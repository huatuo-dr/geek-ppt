...
import { getCyberpunkStyles } from "./cyberpunkStyles";
...
export const cyberpunkRendererPlugin: RendererPlugin = {
  pluginId: "cyberpunk-renderer",
  version: "1.0.0",
  displayName: "赛博朋克",
  supportedNodeTypes: ALL_NODE_TYPES,
  getStyles: getCyberpunkStyles,
};
